...
- In any case, the below python code save the data in the .root G4 output file to .out text file
    ...
    - One can use ROOT (instead of Python) to save .root file into a text file (see README.md in [Monte Carlo Dosimetry GitLab Repo](https://github.com/clarehchao/VoxelizedMonteCarloDosimetry))
